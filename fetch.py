#!/usr/bin/env python3
"""
Recuperation des codes promo OUIGO depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/ouigo.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/ouigo.com"
STORE_NAME = "OUIGO"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour OUIGO depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-ouigo)"
    }
    try:
